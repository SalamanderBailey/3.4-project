...
function main() {
  ...
  nextOne.addEventListener('click', function() {
    if (pageCount < 1) {
      ...
      cutOffOne.style.opaque = "1";
      cutOffTwo.style.opaque = "0.3";
      pageCount = 1;
    }
  });
   nextTwo.addEventListener('click', function() {
    if (pageCount < 2) {
      if (pageCount == 1) {
        ...
        cutOffTwo.style.transition = "all 0.5s ease";
        cutOffTwo.style.opacity = "1";
        cutoffThree.style.opacity = "0.3";
      }
      else {
        addContent(0);
        addContent(1);
  ...
  nextThree.addEventListener('click', function() {
    if (pageCount < 3) {
      if (pageCount == 2) {
        addContent(2);
        var cutOffThree = document.getElementById("cut-off-3");
        cutOffThree.style.transition = "all 0.5s ease";
        cutOffThree.style.opacity = "1";
